//#include "DebugDraw.h"
//
//debugDraw::debugDraw(float32 ratio) : mRatio(ratio)
//{
//	mShaderProgram = CCShaderCache::sharedShaderCache()->programForKey(kCCShader_Position_uColor);
//	mColorLocation = glGetUniformLocation(mShaderProgram->getProgram(), "u_color");
//}
//
//void debugDraw::DrawPolygon(const b2Vec2* old_vertices, int32 vertexCount, const b2Color& color)
//{
//	mShaderProgram->use();
...
//
//	for (int i = 0; setUniformLocationWith4f(mColorLocation, color.r, color.g, color.b, 1);
...
//}
//
//void debugDraw::DrawSolidPolygon(const b2Vec2* old_vertices, int32 vertexCount, const b2Color& color)
//{
//	mShaderProgram->use();
//	mShaderProgram->setUniformsForBuiltins();
//
